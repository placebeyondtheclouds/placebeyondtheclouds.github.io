...
I did this on Ubuntu. Install the necessary software. look up packages to install for languages other than English `apt-cache search tesseract-ocr`. `ocrmypdf` acts as the wrapper around Tesseract OCR. I needed Russian, so I did:
