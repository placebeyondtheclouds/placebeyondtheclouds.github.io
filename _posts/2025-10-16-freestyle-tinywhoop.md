...
| - | - |
| ![1](/assets/images/) | ![2](/assets/images/) |
...
-  recompile betaflight v2025, target `JHEG474`, add features: camera control, alt hold, pos hold. restore the backup

- reflash bluejay, target `Z-H-30`
```
PWM 96kHz 
