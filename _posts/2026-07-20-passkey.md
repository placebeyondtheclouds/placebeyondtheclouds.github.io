...
## backup and restore (of unencrypted firmware)
...
#restore
sha256sum -c rp2350-backup.bin.sha256
...
docker --context rootless run --rm \
  ...
  bash -lc 'picotool load --ignore-partitions -v \
    /workspace/rp2350-backup.bin -t bin &&
    picotool reboot'
```
