...
Update: twitter and google are not accepting this key, I believe they treat it as a simple U2F key and not FIDO2 storage, despite `fido2-token -L -d /dev/hidraw1` reporting `version strings: U2F_V2, FIDO_2_0, FIDO_2_1, FIDO_2_2`. I will try https://github.com/librekeys/pico-fido2 next. Update 2: https://github.com/librekeys/pico-fido2 has the same behavior.
