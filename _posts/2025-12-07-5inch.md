...
- ch6 aux2 SA inverted (change the weight(mixes) to -100%)  - left 3-pos: air (low) / alt hold + pos hold (mid) / angle(high)
...
- (not using) in-flight OSD profile switching on a pot. I use S1, set it to CH10 (AUX6 in BF)
