...
- 2207.5 motors use inner4mm*1mm rubber seal, FPM70 green material
- MGC 2207.5 1960kv, have separately sold bells
...
- in-flight VTX power switching on a pot, used S2 (BF:aux4, radio:ch8). 0 means no change. I won't be using the last most powerful level.
...
tune filters first, then tune PIDs with PIDtoolbox using [this method](https://www.youtube.com/watch?v=ehvQm8Rqrzk)
